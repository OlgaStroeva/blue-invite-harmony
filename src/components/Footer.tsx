      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-muted-foreground">
              Crafting beautiful digital invitations for every occasion.
            </p>
          </div>

          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-blue-700 mb-4">
              Templates
            </h4>
        ...
        <div className="border-t border-blue-100 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} Invite. All rights reserved.
          </p>
