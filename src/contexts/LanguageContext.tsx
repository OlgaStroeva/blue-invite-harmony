...
const enTranslations: Record<string, string> = {
  ...
  "viewAndManageParticipants": "View and manage participants for this event",
  "noParticipantsYet": "No participants yet",
  "shareInvitationFormOrImport": "Share the invitation form or import participant data to get started",
  ...
  "sentInvitationsTo": "Sent invitations to",
...
const ruTranslations: Record<string, string> = {
  ...
  "participantsFor": "Участники для",
  "viewAndManageParticipants": "Просмотр и управление участниками для этого события",
  "noParticipantsYet": "Участников пока нет",
  "shareInvitationFormOrImport": "Поделитесь формой приглашения или импортируйте данные участников для начала работы",
  ...
  "sentInvitationsTo": "Отправлены приглашения для",
  "participantStatusChanged": "Статус участника изменен",
  ...
  "invitationSentSuccessfully": "Приглашение успешно отправлено",
  "invitationCancelled": "Приглашение отменено",
  "invitationCancelledSuccessfully": "Приглашение успешно отменено",
  ...
  "assignStaff": "Назначить сотрудников",
  "viewAssigned": "Просмотр назначенных",
