...
const events: Event[] = await fetch("http://158.160.171.159:7291/api/events/my-events", {
  headers: {
...
const categories: string[] = await fetch("http://158.160.171.159:7291/api/events/my-events", {
  headers: {
    Authorization: `Bearer ${localStorage.getItem("token")}`,
    "Content-Type": "application/json"
  }
